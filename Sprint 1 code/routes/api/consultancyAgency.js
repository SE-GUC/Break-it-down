...
try{
	//Member skills
	const memberSkills = await users.findOne({type:"member",'_id':parseInt(req.params.memberID)},{skills:1,_id:0})
	//Member field
	const memberField = await users.findOne({type:"member",'_id':parseInt(req.params.memberID)},{field:1,_id:0})
	//Resulting tasks
