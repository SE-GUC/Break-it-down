...
class UpdateEntry extends Component {
  ...
  componentDidMount(){
    ...
    axios.get(`/api/admin/viewUser/${id}`)
    .then(res=>{
   ...
   return (
        ...
        <Card style={{ width: '100%' }}>
         ...
         <p style={{color:'#000000'}}>
            { "User with email "+ this.state.email +
            " and name "+this.state.name+" wants to update " +
            ...
            (this.props.updt.address===undefined?
             ...
             (this.props.updt.skills===undefined?
              ...
              <button onClick={this.props.approve.bind(this,this.props.id,this.props.updt._id)} type="button" class="btn btn-outline-success">Approve</button> {'  '}
              <button onClick={this.props.disapprove.bind(this,this.props.id,this.props.updt._id)} type="button" class="btn btn-outline-danger">Disapprove</button>
