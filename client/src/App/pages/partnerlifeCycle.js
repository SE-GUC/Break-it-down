 ...
 getList = async () => {
  ...
  render() {
    const { list } = this.state;
      console.log (list)
      if(list[0]===false && list[1]===false && list[2]===false && list[3]===false){
        return(
    ...
    <br>
        ...
        <h1>Your Task's Life Cycle </h1>
         ...
         <div class="progress-bar bg-success" role="progressbar" style={{ width:"0%",color:"green" }} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
