...
const ReviewForm = (props) => {
 ...
 <PartnerSidnav/>
          ...
          <h1 style={{ color: 'green' }}>
            Review Your assigned applicant
          </h1>
          <input style={{ margin:"50px auto", display:"block" }} type="number" name="rating" placeholder="rating"/>
          <input style={{ margin:"50px auto", display:"block" }} type="text" name="review" placeholder="review"/>
